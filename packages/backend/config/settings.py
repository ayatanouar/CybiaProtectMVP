...
ALLOWED_OAUTH_EMAILS = env.list("ALLOWED_OAUTH_EMAILS", default=[])
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "templates"), os.path.join(BASE_DIR, "apps", "users", "templates"),],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
SOCIAL_AUTH_LOGIN_ERROR_URL = '/auth/oauth/error/'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'apps.users.pipeline.block_unauthorized_emails',
